...
import bigcat.lab.baseappkotlin.base.BaseActivity
import bizverse.lab.healthylifestyle.utils.PermissionsUtil
...
internal fun Fragment.showAlertDialogTwoButton(
    ...
    titleNegativeButton: String? = getString(R.string.cancel),
    onPositiveButtonClick: () -> Unit = {},
    onNegativeButtonClick: () -> Unit = {}
) {
    val dialog =
        AlertDialog.Builder(context, R.style.DialogThemeLight).apply {
            setCancelable(false)
            setTitle(title)
            setMessage(message)
            setPositiveButton(
