package bigcat.lab.baseappkotlin.domain.repository.shared

import android.app.Application
import android.content.Context
import android.os.Build
import android.os.Environment
import com.example.baseappkotlin.R
import java.io.File
...
class SharedPreferenceRepository @Inject constructor(application: Application) {
    ...
    fun createImageFile(): File {
        ...
        else Environment.getExternalStoragePublicDirectory(context.getString(R.string.app_name))
